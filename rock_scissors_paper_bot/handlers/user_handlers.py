...
from rock_scissors_paper_bot.keyboards.keyboard import game_kb, yes_no_kb
from rock_scissors_paper_bot.lexicon.lexicon_ru import LEXICON_RU
from rock_scissors_paper_bot.services.services import get_bot_choice, get_winner
